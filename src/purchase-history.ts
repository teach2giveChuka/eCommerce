document.addEventListener('DOMContentLoaded', () => {
    const historyItemsContainer = document.querySelector('.historyItems') as HTMLElement;
    ...
    purchaseHistory.forEach((product: any) => {
    ...
    function createHistoryProduct(productData: any): HTMLElement {
